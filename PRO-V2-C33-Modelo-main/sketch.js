...
function preload()
{
  ...
  blink = loadAnimation("blink_1.png","blink_1.png","blink_1.png","blink_1.png","blink_1.png","blink_2.png","blink_3.png");
...
function setup() {
  ...
  rope = new Rope(5,{x:230,y:330}); //mudei para 5 segemtos pq n tava tocando o coelho
